...
public class TimeEntryApiJpaTest {
    ...
    public void testCreate() throws Exception {
        ResponseEntity<String> createResponse = restTemplate.postForEntity("/time-entries-jpa", timeEntry, String.class);
    ...
    public void testList() throws Exception {
        ...
        ResponseEntity<String> listResponse = restTemplate.getForEntity("/time-entries-jpa", String.class);
    ...
    public void testRead() throws Exception {
        ...
        ResponseEntity<String> readResponse = this.restTemplate.getForEntity("/time-entries-jpa/" + id, String.class);
    ...
    public void testUpdate() throws Exception {
        Long id = createTimeEntry();
        TimeEntry updatedTimeEntry = new TimeEntry(id, 2L, 3L, LocalDate.parse("2017-01-09"), 9);


        ResponseEntity<String> updateResponse = restTemplate.exchange("/time-entries-jpa/" + id, HttpMethod.PUT, new HttpEntity<>(updatedTimeEntry, null), String.class);
    ...
    public void testDelete() throws Exception {
        ...
        ResponseEntity<String> deleteResponse = restTemplate.exchange("/time-entries-jpa/" + id, HttpMethod.DELETE, null, String.class);


        assertThat(deleteResponse.getStatusCode()).isEqualTo(HttpStatus.NO_CONTENT);

        ResponseEntity<String> deletedReadResponse = this.restTemplate.getForEntity("/time-entries-jpa/" + id, String.class);
    ...
    private Long createTimeEntry() {
        ...
        ResponseEntity<TimeEntry> response = restTemplate.exchange("/time-entries-jpa", HttpMethod.POST, entity, TimeEntry.class);
